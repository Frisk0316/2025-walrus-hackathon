...
import type { AttestKPIResponseTransaction } from './AttestKPIResponseTransaction';
import {
    AttestKPIResponseTransactionFromJSON,
    AttestKPIResponseTransactionFromJSONTyped,
    AttestKPIResponseTransactionToJSON,
} from './AttestKPIResponseTransaction';
...
export interface AttestKPIResponse {
    ...
    /**
     * 
     * @type {AttestKPIResponseTransaction}
     * @memberof AttestKPIResponse
     */
    transaction: AttestKPIResponseTransaction;
}
...
export function AttestKPIResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttestKPIResponse {
    ...
    return {
        ...
        'attestation': KPIAttestationFromJSON(json['attestation']),
        'transaction': AttestKPIResponseTransactionFromJSON(json['transaction']),
    };
}
...
export function AttestKPIResponseToJSON(value?: AttestKPIResponse | null): any {
    ...
    return {
        ...
        'transaction': AttestKPIResponseTransactionToJSON(value.transaction),
    };
}
