...
/**
 * Unsigned transaction to attest KPI on-chain
 * @export
 * @interface AttestKPIResponseTransaction
 */
export interface AttestKPIResponseTransaction {
    /**
     * Base64 encoded transaction bytes
     * @type {string}
     * @memberof AttestKPIResponseTransaction
     */
    txBytes: string;
    /**
     * 
...
/**
 * Check if a given object implements the AttestKPIResponseTransaction interface.
 */
export function instanceOfAttestKPIResponseTransaction(value: object): boolean {
    let isInstance = true;
...
export function AttestKPIResponseTransactionFromJSON(json: any): AttestKPIResponseTransaction {
    return AttestKPIResponseTransactionFromJSONTyped(json, false);
}

export function AttestKPIResponseTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttestKPIResponseTransaction {
...
export function AttestKPIResponseTransactionToJSON(value?: AttestKPIResponseTransaction | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
